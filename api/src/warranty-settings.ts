...
/**
 * Текст гарантий бланка ЗН (пневмоподвеска Mraer).
 * Сроки: аморт 1 год, баллон 2 года, стойка — раздельно, компрессор 1 год.
 */
export function workorderWarrantyObligationLines(_sellerInn?: string | null): string[] {
  return [
...
/** Случаи прерывания гарантии для бланка ЗН (пневмоподвеска). */
export function workorderWarrantyBreakLines(_sellerInn?: string | null): string[] {
  return [
